...
public class ItemsAdapter extends RecyclerView.Adapter<ItemsAdapter.ViewHolder>{
    ...
    //made so adapter and main activity can talk to each other => meant to help when deleting an item from the list
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(String item) {
            ...
            //checking to see if item pressed for a long time, if it is then remove from list
